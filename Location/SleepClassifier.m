...
@implementation SleepClassifier
...
{
    self = [super init];
    NSLog(@"sharedSleepClassifier initialized!");
...
{
    static SleepClassifier *_sleepClassifier = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sleepClassifier = [[SleepClassifier alloc]init];
    });

    return _sleepClassifier;
}
